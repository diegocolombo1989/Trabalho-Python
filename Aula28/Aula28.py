# Aula 28 - 17-12-2019
# Revisão de textos dicionário e arquivos
...
# Faça uma função que receba o texto como parametro e retorne um texto com
#  dicionários.
...
def dados(texto):
    ...
    for i in linha_texto:
        i = linha_texto.strip().split('\n')
        dic = {'Código': texto[0],'Nome': texto[1], 'idade': texto[2], 'sexo': texto[3], 'email': texto[4], 'telefone': texto[5]}
        lista.append(lista)
    return lista
